...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8112&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colcon-python-setup-py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `colcon-python-setup-py` can be installed with:

```
conda install colcon-python-setup-py
```

It is possible to list all of the versions of `colcon-python-setup-py` available on your platform with:
